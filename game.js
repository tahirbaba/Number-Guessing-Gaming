...
if (answers.userGuessedNumber === randomNumber) {
    console.log("Congratulations! you guessed right number."); // and if we guess expect number 13 (randomNumber then in print: Congratulations! you guessed right number.
}
else {
    console.log("you guessed wrong number."); // if we guess except number 13 then in print:  you guessed wrong number. 
}
;
